...
import { User, Heart, Upload, FileText, CheckCircle, AlertCircle, Download, Eye } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <VerificationStatusBanner 
        ...
        documentsCount={donor?.documents.length || 0}
        isDonor={isDonor}
      />
            ...
            {donor?.documents.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Upload your ID proof and blood test reports to get verified
                </p>
              </div>
            ) : (
